...
noise = rand(size(ode_data)[1],size(ode_data)[2]).*0.0
...
loss_n_ode = node_two_stage_function(dudt, u0, tspan, t, noise_ode_data, Tsit5(), reltol=1e-7, abstol=1e-9)
#  loss function
...
cb1 = function ()
    ...
    if mod(sa.count_epochs-1, verify)==0
        ...
        # display(a)
        @save string("/Users/eroesch/github/neural_ODE_fitting/paper/vdP/col_no_noise/", sa.count_epochs, "te_dudt_no_re.bson") dudt
...
using JLD
JLD.save("/Users/eroesch/github/neural_ODE_fitting/paper/vdP/col_no_noise/savelosses_re.jld", "losses", sa.losses)
JLD.save("/Users/eroesch/github/neural_ODE_fitting/paper/vdP/col_no_noise/savetimes_re.jld", "times", sa.times)
JLD.save("/Users/eroesch/github/neural_ODE_fitting/paper/vdP/col_no_noise/savel2s_re.jld", "l2s", sa.l2s)
a
