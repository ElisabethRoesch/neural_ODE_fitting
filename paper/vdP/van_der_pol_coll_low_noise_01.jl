...
cb1 = function ()
    ...
    if mod(sa.count_epochs-1, verify)==0
        ...
        # display(a)
        @save string("/Users/eroesch/github/neural_ODE_fitting/paper/vdP/col_low_noise/", sa.count_epochs, "te_dudt_low_re.bson") dudt
...
using JLD
JLD.save("/Users/eroesch/github/neural_ODE_fitting/paper/vdP/col_low_noise/savelosses_re.jld", "losses", sa.losses)
JLD.save("/Users/eroesch/github/neural_ODE_fitting/paper/vdP/col_low_noise/savetimes_re.jld", "times", sa.times)
JLD.save("/Users/eroesch/github/neural_ODE_fitting/paper/vdP/col_low_noise/savel2s_re.jld", "l2s", sa.l2s)
