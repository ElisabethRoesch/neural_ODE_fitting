...
plot!(pl_2_x2, pl_2_y2, width = 2, color = pred_col_2,alpha = alphas[3], label = labels[3],  grid = "off")
plot!(pl_2_x1, pl_2_y1, width = 2, color = pred_col_2, alpha = alphas[2], label = labels[2], grid = "off")
plot!(pl_2_x, pl_2_y, width = 2, color = pred_col_2, alpha = alphas[1],label = labels[1])
