...
cb1 = function ()
    ...
    if mod(sa.count_epochs-1, verify)==0
        ...
        display(a)
        @save string("paper/vdP/col_low_noise/", sa.count_epochs,"te_dudt.bson") dudt
...
using JLD
JLD.save("paper/vdP/col_low_noise/savelosses.jld", "losses", sa.losses)
JLD.save("paper/vdP/col_low_noise/savetimes.jld", "times", sa.times)
JLD.save("paper/vdP/col_low_noise/savel2s.jld", "l2s", sa.l2s)
