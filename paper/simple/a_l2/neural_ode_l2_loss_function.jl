...
cb = function ()
    ...
    if mod(sa_l2.count_epochs-1, verify)==0
        ...
        display(a)
        savefig(string("paper/simple/a_l2/", sa_l2.count_epochs,"te_fit_in_statespace.pdf"))
        @save string("paper/simple/a_l2/", sa_l2.count_epochs,"te_dudt.bson") dudt
    end
end
...
using JLD
JLD.save("paper/simple/a_l2/savelosses.jld", "sal2_losses", sa_l2.losses)
JLD.save("paper/simple/a_l2/savetimes.jld", "l2_times", sa_l2.times)
