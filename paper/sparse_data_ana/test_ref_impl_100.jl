...
scatter(tsteps,data')
plot!(tsteps,u',lw=5)
savefig("paper/sparse_data_ana/colloc_100.png")
plot(tsteps,du')
savefig("paper/sparse_data_ana/colloc_du_100.png")
...
savefig("paper/sparse_data_ana/colloc_trained_100_loss_$val.png")
@save "paper/sparse_data_ana/100_dudt_stage1.bson" dudt2
...
savefig("paper/sparse_data_ana/post_trained_100_loss_$val2.png")
@save "paper/sparse_data_ana/100_dudt_stage2.bson" dudt2
