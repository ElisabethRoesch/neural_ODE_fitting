...
scatter(tsteps,data')
plot!(tsteps,u',lw=5)
savefig("paper/sparse_data_ana/colloc_200.png")
plot(tsteps,du')
savefig("paper/sparse_data_ana/colloc_du_200.png")
...
savefig("paper/sparse_data_ana/colloc_trained_200_loss_$val.png")
@save "paper/sparse_data_ana/200_dudt_stage1.bson" dudt2
