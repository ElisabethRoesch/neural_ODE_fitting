...
scatter(tsteps,data')
plot!(tsteps,u',lw=5)
savefig("paper/sparse_data_ana/colloc_300.png")
plot(tsteps,du')
savefig("paper/sparse_data_ana/colloc_du_300.png")
...
savefig("paper/sparse_data_ana/post_trained_300_loss_$val2.png")
